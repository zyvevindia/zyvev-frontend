...
export const TIER1_CATALOG_DEFINITIONS = [
  ...
  buildTataTiagoTier1Definition(),
  {
    ...
    chargingMeta: { acKw: 7.2, dcKw: 70, port: "CCS2", dcMinutes: 40 },
    variants: [
      {
        slug: "accomplished-x55",
        name: "Accomplished X55",
        priceInr: 1699000,
        rangeKmClaimed: 502,
        rangeKmRealWorld: 400,
        batteryKwh: 55,
        specs: { powerPs: 167, powerKw: 123, torqueNm: 215 },
        compareSpecs: {
          powerPs: 167,
          powerKw: 123,
          dcChargingKw: 70,
          dcChargingTimeMinutes: 40,
        },
      },
      {
        slug: "empowered-x55",
      ...
      {
        slug: "empowered-x55-dark",
        name: "Empowered X55 Dark",
        priceInr: 1949000,
        rangeKmClaimed: 502,
        rangeKmRealWorld: 405,
        batteryKwh: 55,
