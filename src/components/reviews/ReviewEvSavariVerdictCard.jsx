...
export default function ReviewEvSavariVerdictCard({ verdict }) {
  ...
  const hasColumns = bestFor.length > 0 || considerations.length > 0;
  ...
  return (
    <article className="review-page__ev-verdict-card">
      ...
      {hasColumns ? (
        <div className="review-page__ev-verdict-columns">
          {bestFor.length ? (
            <div className="review-page__ev-verdict-block review-page__ev-verdict-block--best-for">
          ...
          {considerations.length ? (
            <div className="review-page__ev-verdict-block review-page__ev-verdict-block--considerations">
