...
- Name: assistant/assistant-flow.spec.js >> Assistant journey flows >> Scenario 2 — budget city commuter sees affordable EVs
- Location: tests/assistant/assistant-flow.spec.js:24:3
