...
- Name: assistant/restart-flow.spec.js >> Assistant restart flow >> restart clears answers and returns to the first question
- Location: tests/assistant/restart-flow.spec.js:14:3
